                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="text-center p-20 upgrade-btn">
                            <a href="<?=base_url()?>/https://www.wrappixel.com/templates/ampleadmin/"
                                ...
                                <div
                                    ...
                                    <div class="gm-style"
                                        ...
                                        <div class="gmnoprint gm-style-cc" draggable="false"
                                            ...
                                            <div
                                                style="position: relative; padding-right: 6px; padding-left: 6px; box-sizing: border-box; font-family: Roboto, Arial, sans-serif; font-size: 10px; color: rgb(68, 68, 68); white-space: nowrap; direction: ltr; text-align: right; vertical-align: middle; display: inline-block;">
                                                <a href="<?=base_url()?>/https://www.google.com/intl/en-US_US/help/terms_maps.html"
                                    ...
                                    <table style="width: 100%;">
                                        <tr>
                                            <td style="line-height: 16px; vertical-align: middle;"><a
                                                    href="<?=base_url()?>/https://developers.google.com/maps/documentation/javascript/error-messages?utm_source=maps_js&amp;utm_medium=degraded&amp;utm_campaign=keyless#api-key-and-billing-errors"
                                                    target="_blank" rel="noopener"
