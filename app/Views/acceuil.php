    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
                    ...
                    <ul class="navbar-nav ms-auto d-flex align-items-center">
                        ...
                        <li>
                            <a class="profile-pic" href="<?=base_url()?>/#">
                                <img src="<?=base_url()?>/plugins/images/users/varun.jpg" alt="user-img" width="36"
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?=base_url()?>/Home/basic-table"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?=base_url()?>/Home/map-google"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?=base_url()?>/Home/erreur"
                                aria-expanded="false">
        ...
        <div class="page-wrapper">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex">
                            ...
                            <a href="<?=base_url()?>/https://www.wrappixel.com/templates/ampleadmin/" target="_blank"
                        ...
                        <div class="card white-box p-0">
                            ...
                            <div class="comment-widgets">
                                ...
                                <div class="d-flex flex-row comment-row p-3 mt-0">
                                    <div class="p-2"><img src="<?=base_url()?>/plugins/images/users/varun.jpg" alt="user" width="50" class="rounded-circle"></div>
                                ...
                                <div class="d-flex flex-row comment-row p-3">
                                    <div class="p-2"><img src="<?=base_url()?>/plugins/images/users/genu.jpg" alt="user" width="50" class="rounded-circle"></div>
                                ...
                                <!-- Comment Row -->
                                <div class="d-flex flex-row comment-row p-3">
                                    <div class="p-2"><img src="<?=base_url()?>/plugins/images/users/ritesh.jpg" alt="user" width="50" class="rounded-circle"></div>
                                    <div class="comment-text ps-2 ps-md-3 w-100">
            ...
            <footer class="footer text-center"> 2021 © Ample Admin brought to you by <a
                    href="<?=base_url()?>/https://www.wrappixel.com/">wrappixel.com</a>
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
